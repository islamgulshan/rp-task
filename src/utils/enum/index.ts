export enum ResponseMessage {
  ...
  EMAIL_SENDING_ERROR = "Please check SENDGRID APIKEY",
  ...
  INVALID_MAKE= 'Invalid make',
  INVALID_REGISTRATION_NO= 'Invalid registration no',
  

  CATEGORY_ALREADY_EXIST = `Team member with the same email already exists`,
